...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR_1, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, MAP_VICTORY_ROAD_1F),
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_3, TRAINER_JUAN_3, MAP_SOOTOPOLIS_CITY),
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE_2, TRAINER_WALLACE_2, TRAINER_WALLACE_2, TRAINER_WALLACE_2, TRAINER_WALLACE_2, MAP_EVER_GRANDE_CITY),
};
