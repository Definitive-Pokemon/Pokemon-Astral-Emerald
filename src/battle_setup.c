...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, MAP_SOOTOPOLIS_CITY),
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, MAP_EVER_GRANDE_CITY),
};
