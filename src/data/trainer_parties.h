...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Valerie5[] = {
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_AERIAL_ACE, MOVE_BUG_BUZZ, MOVE_FAINT_ATTACK, MOVE_SHADOW_BALL}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_MISMAGIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SURF, MOVE_RAIN_DANCE}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_ICE_BEAM, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Lao5[] = {
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_POISON_FANG, MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_BITE}
    }
    };
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_James5[] = {
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_BATON_PASS, MOVE_PROTECT, MOVE_SUBSTITUTE, MOVE_FAINT_ATTACK}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR3[] = {
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_PROTECT}
    }
};
// Rematch 3
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Andres5[] = {
    ...
    .ability = ABILITY_SLOT_2,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_SANDSTORM, MOVE_POISON_JAB, MOVE_ROCK_TOMB}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVs sParty_Phoebe2[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 70,
...
static const struct TrainerMonItemCustomMovesEVs sParty_Drake2[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_GIGA_DRAIN, MOVE_DRAGON_PULSE, MOVE_THUNDER_PUNCH, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 73,
