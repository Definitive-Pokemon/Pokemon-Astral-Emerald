...
static const struct TrainerMonNoItemCustomMoves sParty_ShellySeafloorCavern[] = {
    ...
    .lvl = 45,
    .species = SPECIES_GOREBYSS,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_HYDRO_PUMP, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_VITAL_THROW, MOVE_KNOCK_OFF, MOVE_EARTHQUAKE, MOVE_STONE_EDGE}
    },
    {
    .iv = 150,
    .lvl = 46,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AIR_CUTTER, MOVE_BITE, MOVE_POISON_JAB, MOVE_HAZE}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Rose5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_JUMPLUFF,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_LEAF_BLADE, MOVE_POISON_JAB, MOVE_SLEEP_POWDER, MOVE_ENCORE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 252, 0, 0, 0},
    .moves = {MOVE_LEAF_BLADE, MOVE_SLASH, MOVE_X_SCISSOR, MOVE_ENDURE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonNoItemCustomMoves sParty_Charlie[] = {
    {
    .iv = 0,
    .lvl = 30,
...
static const struct TrainerMonNoItemCustomMoves sParty_Vito[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_CHARGE, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 220,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Valerie5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_MOONLIGHT, MOVE_WILL_O_WISP, MOVE_FIRE_PUNCH, MOVE_SHADOW_CLAW}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_ENDURE, MOVE_DESTINY_BOND, MOVE_SHADOW_CLAW, MOVE_THUNDER_WAVE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_DAZZLING_GLEAM}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_AERIAL_ACE, MOVE_X_SCISSOR, MOVE_FAINT_ATTACK, MOVE_SHADOW_CLAW}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP}
    }
};
//Route 104 Lady
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica5[] = {
    ...
    .moves = {MOVE_GLARE, MOVE_POISON_JAB, MOVE_BITE, MOVE_STOCKPILE}
    },
    {
    .iv = 40,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Nob5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_PRIMEAPE,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Dalton5[] = {
    {
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_HIDDEN_POWER, MOVE_THUNDER, MOVE_EXPLOSION, MOVE_THUNDER_WAVE}
    },
    {
    .ivs = BEST_IV_SPREAD_HIDDEN_POWER_ICE,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_CROSS_CHOP, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH, MOVE_THUNDER_WAVE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Bernie5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_SUNNY_DAY, MOVE_OVERHEAT, MOVE_DARK_PULSE, MOVE_PSYCHIC}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Jacki5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_ALAKAZAM,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_SIGNAL_BEAM}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_FIRE_PUNCH, MOVE_FOCUS_BLAST}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PURSUIT, MOVE_DRILL_PECK, MOVE_STEEL_WING, MOVE_HAZE}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_BLADE, MOVE_DARK_PULSE, MOVE_AERIAL_ACE, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_SCOPE_LENS,
    .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_CRUNCH, MOVE_AVALANCHE}
    },
    {
    .iv = 250,
    .lvl = 51,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .moves = {MOVE_CRUNCH, MOVE_IRON_TAIL, MOVE_STONE_EDGE, MOVE_SHADOW_CLAW}
    }
};
// Elite Four
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MOONLIGHT, MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 250,
    .lvl = 53,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_DOUBLE_EDGE, MOVE_REVENGE, MOVE_DESTINY_BOND}
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_SCOPE_LENS,
    .moves = {MOVE_FAINT_ATTACK, MOVE_BLIZZARD, MOVE_SWORDS_DANCE, MOVE_POISON_JAB}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_AVALANCHE, MOVE_ROCK_SLIDE, MOVE_REST}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_BLIZZARD, MOVE_HAIL, MOVE_CONFUSE_RAY}
    },
    { //Gardevoir
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_STONE_EDGE, MOVE_IRON_TAIL, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_SURF, MOVE_DRAGON_PULSE}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_LEECH_SEED, MOVE_ENERGY_BALL, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_STONE_EDGE, MOVE_CRUNCH}
    }
};
//Rustboro Gym Leader
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FACADE, MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_KNOCK_OFF}
    },
    {
    .iv = 200,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_GOREBYSS,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_MOONBLAST, MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .species = SPECIES_SEAKING,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_WATERFALL, MOVE_MEGAHORN, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_AVALANCHE, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RECOVER, MOVE_SURF, MOVE_BLIZZARD, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_THUNDER, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_SPIKES, MOVE_SKY_ATTACK, MOVE_STEEL_WING, MOVE_WHIRLWIND}
    },
    {
    .iv = 255,
    .lvl = 58,
...
// Champion (Rematch)
static const struct TrainerMonItemCustomMovesEVs sParty_Wallace2[] = {
    {
    .iv = 255,
    .lvl = 77,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_CHOICE_BAND,
    .evs = {0, 252, 0, 0, 0, 252},
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_DRAGON_PULSE, MOVE_THUNDERBOLT, MOVE_RECOVER, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_WATERFALL, MOVE_REST, MOVE_DRAGON_DANCE, MOVE_OUTRAGE}
    },
    {
    .iv = 255,
    .lvl = 78,
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .evs = {252, 0, 252, 0, 0, 0},
    .moves = {MOVE_SURF, MOVE_RECOVER, MOVE_MOONBLAST, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Benjamin5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_METAL_CLAW, MOVE_CRUNCH, MOVE_PLAY_ROUGH, MOVE_ROCK_SLIDE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 252, 0, 252, 0},
    .moves = {MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_REST, MOVE_FLASH_CANNON}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_X_SCISSOR, MOVE_REVERSAL, MOVE_ENDURE, MOVE_BATON_PASS}
    }
};
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Nicolas5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_KINGDRA,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DRAGON_PULSE, MOVE_FIRE_BLAST}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_PLAY_ROUGH, MOVE_SKY_ATTACK, MOVE_AERIAL_ACE, MOVE_THIEF}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Robert5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_SALAMENCE,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_HYDRO_PUMP, MOVE_FIRE_BLAST, MOVE_DRAGON_PULSE, MOVE_WISH}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_POISON_JAB}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Lao5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_MUK,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_ENERGY_BALL, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED, MOVE_EARTHQUAKE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_POISON_JAB, MOVE_TAUNT}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_POISON_JAB, MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_BITE}
    }
    };
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Jenny5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_DOUBLE_TEAM}
    }
};
// Rival 1
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Isaac5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_MIGHTYENA,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_SWORDS_DANCE, MOVE_BLIZZARD, MOVE_FAINT_ATTACK, MOVE_POISON_JAB}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_ENDURE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_OVERHEAT, MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_WILL_O_WISP}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_DRAGON_DANCE, MOVE_STONE_EDGE}
    }
};
// Route 117 BreederF
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_James5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_NINJASK,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_BATON_PASS, MOVE_PROTECT, MOVE_SUBSTITUTE, MOVE_X_SCISSOR}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_ENDURE, MOVE_DRAGON_PULSE, MOVE_HYPNOSIS, MOVE_TWINEEDLE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_X_SCISSOR, MOVE_ROCK_BLAST, MOVE_METAL_CLAW, MOVE_BRICK_BREAK}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_SIGNAL_BEAM, MOVE_ENERGY_BALL}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .moves = {MOVE_SLEEP_POWDER, MOVE_SUBSTITUTE, MOVE_ENERGY_BALL, MOVE_PSYCHIC}
    }
};
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Trent5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_TYRANITAR,
    ...
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CRUNCH, MOVE_STONE_EDGE, MOVE_REST}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 0, 0, 252},
    .moves = {MOVE_EXPLOSION, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 0, 0, 0, 0, 252},
    .moves = {MOVE_RECOVER, MOVE_ENERGY_BALL, MOVE_LEECH_SEED, MOVE_MIRROR_COAT}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_BULK_UP}
    }
};
// Rematch 2
static const struct TrainerMonItemCustomMoves sParty_WallyVR3[] = {
    ...
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_PERSIM_BERRY,
    .moves = {MOVE_PETAL_DANCE, MOVE_LEECH_SEED, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 255,
    .lvl = 61,
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_X_SCISSOR}
    }
};
// Rematch 3
static const struct TrainerMonItemCustomMoves sParty_WallyVR4[] = {
    ...
    .species = SPECIES_MEGANIUM,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_GRASS_WHISTLE, MOVE_LEECH_SEED, MOVE_EARTHQUAKE, MOVE_ENERGY_BALL}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_ICE_PUNCH}
    }
};
// Rematch 4
static const struct TrainerMonItemCustomMoves sParty_WallyVR5[] = {
    ...
    .heldItem = ITEM_WIKI_BERRY,
    .moves = {MOVE_BODY_SLAM, MOVE_METEOR_MASH, MOVE_DAZZLING_GLEAM, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 73,
...
static const struct TrainerMonNoItemCustomMoves sParty_BrendanLilycoveTorchic[] = {
    ...
    .lvl = 36,
    .species = SPECIES_PINSIR,
    .moves = {MOVE_SEISMIC_TOSS, MOVE_REVENGE, MOVE_X_SCISSOR, MOVE_BRICK_BREAK}
    },
    {
    .iv = 150,
    .lvl = 36,
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .lvl = 52,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_BRICK_BREAK, MOVE_STONE_EDGE, MOVE_REST, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TabithaMagmaHideout[] = {
    ...
    .lvl = 36,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_WING_ATTACK, MOVE_GIGA_DRAIN, MOVE_POISON_JAB, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 50,
    .lvl = 35,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .species = SPECIES_ARMALDO,
    .heldItem = ITEM_KINGS_ROCK,
    .moves = {MOVE_STONE_EDGE, MOVE_METAL_CLAW, MOVE_X_SCISSOR, MOVE_ROCK_SMASH}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_SANDSTORM, MOVE_INGRAIN, MOVE_RECOVER, MOVE_ENERGY_BALL}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SMELLING_SALT, MOVE_FLASH_CANNON, MOVE_POWER_GEM, MOVE_THUNDER_WAVE}
    }
};
// Roxanne Rematch 3
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .species = SPECIES_TYRANITAR,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_ROCK_SLIDE, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_STONE_EDGE, MOVE_DOUBLE_EDGE, MOVE_X_SCISSOR}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_CRADILY,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_INGRAIN, MOVE_ANCIENT_POWER, MOVE_ENERGY_BALL, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_FLASH_CANNON, MOVE_POWER_GEM, MOVE_THUNDER, MOVE_EARTH_POWER}
    }
};
// Roxanne Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Roxanne5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_TYRANITAR,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_STONE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_FLASH_CANNON, MOVE_POWER_GEM, MOVE_THUNDER_WAVE, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_BODY_SLAM, MOVE_STONE_EDGE, MOVE_CROSS_CHOP, MOVE_EARTHQUAKE}
    }
};
// Brawly Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Brawly5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_HITMONTOP,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_FOCUS_PUNCH, MOVE_REVENGE, MOVE_STONE_EDGE, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = {
    ...
    .species = SPECIES_MAGNEZONE,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_THUNDER_WAVE, MOVE_REFLECT, MOVE_THUNDER, MOVE_FLASH_CANNON}
    },
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_ELECTIVIRE,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_CROSS_CHOP, MOVE_FIRE_PUNCH, MOVE_THUNDER, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 60,
...
// Wattson Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Wattson5[] = {
     {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_RAICHU,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .species = SPECIES_SUNFLORA,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_SYNTHESIS, MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .species = SPECIES_SUNFLORA,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_FLAMETHROWER, MOVE_SYNTHESIS, MOVE_LEECH_SEED, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 60,
...
// Flannery Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Flannery5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_ARCANINE,
    ...
    .heldItem = ITEM_PETAYA_BERRY,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT, MOVE_FIRE_BLAST, MOVE_DARK_PULSE}
    },
    {
    .iv = 255,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKILL_SWAP, MOVE_SHADOW_CLAW, MOVE_THUNDERBOLT, MOVE_BODY_SLAM}
    },
    {
    .iv = 250,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_SPELL_TAG,
    .moves = {MOVE_SHADOW_CLAW, MOVE_DOUBLE_EDGE, MOVE_THUNDERBOLT, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 55,
...
// Norman Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Norman5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_SLAKING,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_POISON_JAB, MOVE_GIGA_DRAIN, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SMASH, MOVE_ENERGY_BALL, MOVE_EARTHQUAKE, MOVE_WHIRLWIND}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_SKY_ATTACK}
    }
};
// Winona Rematch 2
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = {
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_SKY_ATTACK, MOVE_DOUBLE_EDGE, MOVE_MOONBLAST, MOVE_EARTHQUAKE}
    }
};
// Winona Rematch 3
...
// Winona Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_Winona5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_DRAGONITE,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_FIRE_BLAST, MOVE_DRAGON_PULSE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 65,
    ...
    .heldItem = ITEM_SOFT_SAND,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_RAZOR_LEAF, MOVE_SYNTHESIS}
    },
    {
    .iv = 255,
    .lvl = 65,
...
// Tate & Liza Rematch 4
static const struct TrainerMonItemCustomMovesEVs sParty_TateAndLiza5[] = {
    {
    .iv = 255,
    .lvl = 65,
    .species = SPECIES_CLAYDOL,
    ...
    .heldItem = ITEM_APICOT_BERRY,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_PSYCHIC, MOVE_HYPER_BEAM, MOVE_CALM_MIND, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 255,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVs sParty_Juan5[] = {
    {
    .iv = 255,
    .lvl = 65,
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .evs = {252, 0, 0, 0, 252, 0},
    .moves = {MOVE_RAIN_DANCE, MOVE_YAWN, MOVE_HYDRO_CANNON, MOVE_FLASH_CANNON}
    },
    {
    .iv = 255,
    .lvl = 65,
...
// Post Game Boss
static const struct TrainerMonItemCustomMovesEVs sParty_Steven2[] = {
    {
    .iv = 255,
    .lvl = 76,
    .species = SPECIES_ARMALDO,
    .heldItem = ITEM_SCOPE_LENS,
    .evs = {0, 252, 252, 0, 0, 0},
    .moves = {MOVE_STONE_EDGE, MOVE_X_SCISSOR, MOVE_FACADE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .evs = {0, 252, 252, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 77,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_STONE_EDGE, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 78,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Andres5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_GLISCOR,
    ...
    .ability = ABILITY_SLOT_2,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_SANDSTORM, MOVE_POISON_JAB, MOVE_STONE_EDGE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_STONE_EDGE, MOVE_AERIAL_ACE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Pablo5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_BLIZZARD, MOVE_POISON_JAB, MOVE_FAINT_ATTACK, MOVE_METAL_CLAW}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_AVALANCHE, MOVE_HAIL, MOVE_REST}
    }
...
static const struct TrainerMonItemCustomMovesEVsSpecificAbility sParty_Cristin5[] = {
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
    .species = SPECIES_TAUROS,
    ...
    .ability = ABILITY_SLOT_1,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_BULK_UP, MOVE_DOUBLE_EDGE, MOVE_AERIAL_ACE}
    },
    {
    .ivs = BEST_IV_SPREAD,
    .lvl = 65,
...
static const struct TrainerMonNoItemCustomMoves sParty_Red[] = {
    ...
    .moves = {MOVE_CRUSH_GRIP, MOVE_ENERGY_BALL, MOVE_STONE_EDGE, MOVE_X_SCISSOR}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_Sidney2[] = {
    ...
    .heldItem = ITEM_PETAYA_BERRY,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_PROTECT, MOVE_SUBSTITUTE, MOVE_BATON_PASS, MOVE_X_SCISSOR}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .heldItem = ITEM_CHARCOAL,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_DARK_PULSE, MOVE_FIRE_BLAST, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_DRILL_PECK, MOVE_PURSUIT, MOVE_DARK_PULSE, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 69,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_CRUNCH, MOVE_FACADE, MOVE_STONE_EDGE, MOVE_SHADOW_CLAW}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_Phoebe2[] = {
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_TAUNT, MOVE_WILL_O_WISP}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .heldItem = ITEM_LIECHI_BERRY,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_SHADOW_CLAW, MOVE_DOUBLE_EDGE, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 255,
    .lvl = 69,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_CROSS_CHOP, MOVE_STONE_EDGE, MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .evs = {252, 0, 0, 0, 0, 252},
    .moves = {MOVE_SHADOW_PUNCH, MOVE_ICE_BEAM, MOVE_CALM_MIND, MOVE_PAIN_SPLIT}
    }
};
...
static const struct TrainerMonItemCustomMovesEVs sParty_Glacia2[] = {
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .evs = {0, 252, 0, 0, 252, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_AVALANCHE, MOVE_STONE_EDGE, MOVE_HAIL}
    },
    {
    .iv = 255,
    .lvl = 71,
...
static const struct TrainerMonItemCustomMovesEVs sParty_Drake2[] = {
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .evs = {252, 252, 0, 0, 0, 0},
    .moves = {MOVE_EARTHQUAKE, MOVE_OUTRAGE, MOVE_DOUBLE_EDGE, MOVE_DRILL_PECK}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .evs = {0, 0, 0, 252, 252, 0},
    .moves = {MOVE_ENERGY_BALL, MOVE_DRAGON_PULSE, MOVE_LEECH_SEED, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .evs = {0, 252, 0, 252, 0, 0},
    .moves = {MOVE_IRON_TAIL, MOVE_DRAGON_DANCE, MOVE_STONE_EDGE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Courtney2[] = {
     {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_MURKROW,
...
static const struct TrainerMonItemCustomMoves sParty_ArchieMtPyre[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_POISON_JAB, MOVE_TOXIC, MOVE_FLY}
    },
    {
    .iv = 220,
    .lvl = 39,
