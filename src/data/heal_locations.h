static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_KNOT_ISLAND - 1] = {MAP_GROUP(KNOT_ISLAND), MAP_NUM(KNOT_ISLAND), 14, 6},
    [HEAL_LOCATION_BOON_ISLAND - 1] = {MAP_GROUP(BOON_ISLAND), MAP_NUM(BOON_ISLAND), 20, 8},
    [HEAL_LOCATION_KIN_ISLAND - 1] = {MAP_GROUP(KIN_ISLAND), MAP_NUM(KIN_ISLAND), 14, 27},
    [HEAL_LOCATION_FLOE_ISLAND - 1] = {MAP_GROUP(FLOE_ISLAND), MAP_NUM(FLOE_ISLAND), 18, 21},
    [HEAL_LOCATION_CHRONO_ISLAND - 1] = {MAP_GROUP(CHRONO_ISLAND), MAP_NUM(CHRONO_ISLAND), 17, 7},
    [HEAL_LOCATION_FORTUNE_ISLAND - 1] = {MAP_GROUP(FORTUNE_ISLAND), MAP_NUM(FORTUNE_ISLAND), 17, 7},
    [HEAL_LOCATION_QUEST_ISLAND - 1] = {MAP_GROUP(QUEST_ISLAND), MAP_NUM(QUEST_ISLAND), 11, 4},
};
