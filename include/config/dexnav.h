...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x4FF // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x500 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x501 // Allow player to find hidden mons
