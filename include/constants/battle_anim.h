...
#define ANIM_TAG_STONE_EDGE                 (ANIM_SPRITES_START + 295)
#define ANIM_TAG_ENERGY_BALL                (ANIM_SPRITES_START + 296)
#define ANIM_TAG_GRAB_AWAY                  (ANIM_SPRITES_START + 297)
#define ANIM_TAG_GRAB_TOWARDS               (ANIM_SPRITES_START + 298)
